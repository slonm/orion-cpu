...
/**
 * Класс, который описывает поле типа "Какое-нибудь действительное число"
 * @param <B> конкретный тип действительного числа
 * @author Gennadiy Dobrovolsky
 */
public class GridFieldNumberAbstractFloat<B> extends GridFieldAbstract<B> {
