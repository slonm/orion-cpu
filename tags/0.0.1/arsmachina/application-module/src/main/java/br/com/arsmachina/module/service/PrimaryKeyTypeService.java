...
/**
 * Service that informs the primary key field type of a given entity class. Implementations are not
 * obliged to provide this service for any entity class
 * 
...
public interface PrimaryKeyTypeService {
	 ...
	 * </p>
	 * <p>
	 * The primary key field type of a given class may not be the one used as primary key column in
	 * the database. This can be used to provide prettier URLs for {@link ActionLink}s,
	...
	/**
	 * Returns the name of the property used as primary key in a given class. The same assumptions
	 * made to {@link #getPrimaryKeyType(Class)} applies here.
	 * 
	 * @param entityClass a {@link Class} instance. It cannot be null.
