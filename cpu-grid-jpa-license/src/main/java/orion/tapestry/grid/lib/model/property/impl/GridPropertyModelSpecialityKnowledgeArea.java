 ...
 * @author dobro
 */
public class GridPropertyModelSpecialityKnowledgeArea extends GridPropertyModelAdapter {

    public GridPropertyModelSpecialityKnowledgeArea(
        ...
        String fieldName = "trainingDirection.knowledgeArea.name";
        ...
        this.setSortConstraint(new GridSortConstraint(this, ColumnSort.UNSORTED, 0) {
            ...
            public String getPropertyName() {
                return "trainingDirection.knowledgeArea.name";
            }
        });
    }
    //    @Override
