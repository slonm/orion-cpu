 ...
 * @author dobro
 */
public class GridPropertyModelLicenseRecord extends GridPropertyModelAdapter {

    public GridPropertyModelLicenseRecord(
        ...
        String fieldName = this.propertyName + ".speciality.name";
