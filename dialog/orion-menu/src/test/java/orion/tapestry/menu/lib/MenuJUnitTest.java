...
import ua.orion.tapestry.menu.services.OrionMenuServiceImpl;
...
public class MenuJUnitTest {
    ...
    public void setUp() {
        ...
        for (String s : path) {
            config.put(s, new PageMenuLink(this.getClass().getSimpleName()));
        }
    ...
    public void testCpuMenuImpl_1() {
        ...
        OrionMenuServiceImpl menu = new OrionMenuServiceImpl(this.config, null, null);
    ...
    public void testCpuMenuImpl_2() {
        OrionMenuServiceImpl mnu = new OrionMenuServiceImpl(this.config, null, null);
        MenuData md;
        Object[] items;
