...
import org.tynamo.security.core.services.SecurityCoreModule;

/**
 * This module is automatically included as part of the Tapestry IoC Registry, it's a good place to
 * configure and extend Tapestry, or to place your own service definitions.
 */
@SubModule(value = {SecurityCoreModule.class, SecurityModule.class, AppSubModule.class})
public class AppModule
{
	...
	public static void contributeApplicationDefaults(MappedConfiguration<String, String> configuration) {
		...
		configuration.add(SecurityCoreSymbols.SHOULD_LOAD_INI_FROM_CONFIG_PATH, "true");
	}
