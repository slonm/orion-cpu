 ...
 * @author kgp
 * В УЧЕБНОМ ПЛАНЕ ИСПОЛЬЗУЕТСЯ ТОЛЬКО EduPlanDiscipline с обобщёнными по семетсрам
 * сведениями ою учебной дисциплине
...
//
//    /**
//     * Двунаправленная ассоцияация с дисциплиной учебного плана, для которой есть
//     * данная запись
//     * @return дисциплина учебного плана
//     */
//    @ManyToOne
//    @NonVisual
