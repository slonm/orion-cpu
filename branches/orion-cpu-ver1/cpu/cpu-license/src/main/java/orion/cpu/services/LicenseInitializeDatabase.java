...
public class LicenseInitializeDatabase extends OperationTypes implements Runnable {
    ...
    public void run() {
        ...
        //---------Группы лицензионных записей (область действия лицензий) ---------
        ...
        if (iDBSpt.isFillTestData()) {
            ...
            KnowledgeAreaOrTrainingDirection kaotdMst = saveOrUpdateKAOTD("Мистецтво", null, "0202", true, false);
...
//          //Культура
           ...
           // TrainingDirectionOrSpeciality tdosMV_B = saveOrUpdateTDOS("Міжнародні відносини", "МВ", "01", true, kaotdIntRelat, false);
            ...
            //Мистецтво (NEW)
            TrainingDirectionOrSpeciality tdosDZ_B = saveOrUpdateTDOS("Дизайн", "ДЗ", "07", true, kaotdMst, false);
            ...
            TrainingDirectionOrSpeciality tdosTO_JS = saveOrUpdateTDOS("Туристичне обслуговування", "ТО", "0301", false, kaotdServSect, false);

            //---Серия, номер и дата выдачи лицензии----------
            LOG.debug("Add Test License...");
            Calendar licCal = Calendar.getInstance();
            licCal.set(Calendar.YEAR, 2010);
            licCal.set(Calendar.MONTH, Calendar.NOVEMBER);
            licCal.set(Calendar.DAY_OF_MONTH, 5);
            License licenseCPU = saveOrUpdateLicense("АВ", "529699", licCal.getTime(), null);
...
//            OrgUnit kafUND = ouCnt.findByNameFirst("Неопределенная");
            ...
            //Термін закінчення ліцензій 2013.07.01
            Calendar cal_2014_07_01 = Calendar.getInstance();
            cal_2014_07_01.set(Calendar.YEAR, 2014);
            cal_2014_07_01.set(Calendar.MONTH, Calendar.JULY);
            cal_2014_07_01.set(Calendar.DAY_OF_MONTH, 1);

            //Термін закінчення ліцензій 2013.07.01
            Calendar cal_2015_07_01 = Calendar.getInstance();
            cal_2015_07_01.set(Calendar.YEAR, 2015);
            cal_2015_07_01.set(Calendar.MONTH, Calendar.JULY);
            cal_2015_07_01.set(Calendar.DAY_OF_MONTH, 1);
