...
public class LicenseRecords {
    ...
    //    private Grid grid;
    /**
     * Лицензия, которой принадлежат показанные записи
     */
    ...
    public DataSource getDataSource() {
        ...
        final RestrictionEditorJPACriteria editor = new RestrictionEditorJPACriteria(objectClass, entityManager);
        JPADataSource dataSource = new JPADataSource(gridBeanModel, entityManager, editor) {
            ...
            protected void applyAdditionalConstraints(CriteriaQuery criteriaQuery) {
                ...
                Predicate oldRestriction = criteriaQuery.getRestriction();
                Predicate newRestriction = criteriaBuilder.equal(editor.toExpression("license"), license);
                if (oldRestriction != null) {
                    newRestriction = criteriaBuilder.and(oldRestriction,newRestriction);
                }
                criteriaQuery.where(newRestriction);
            }
        };
        return dataSource;
    }
    ...
    public Object onActivate(EventContext context) {
        ...
        if (context.getCount() >= 2) {
            license = (License) context.get(License.class, 1);
        }
        // тип сущности
        objectClass = LicenseRecord.class;
        ...
        public Object[] onPassivate() {
            Object[] context={this.objectClass.getSimpleName(), this.license};
            return context;
        }
    /**
