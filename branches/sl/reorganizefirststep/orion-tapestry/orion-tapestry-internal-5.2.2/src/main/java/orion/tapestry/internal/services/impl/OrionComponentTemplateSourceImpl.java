 ...
 */
public final class OrionComponentTemplateSourceImpl extends InvalidationEventHubImpl implements ComponentTemplateSource,
        UpdateListener
{
    ...
    public OrionComponentTemplateSourceImpl(TemplateParser parser, @Primary
    ComponentTemplateLocator templateLocator, ClasspathURLConverter classpathURLConverter)
    {
        this(parser, templateLocator, new DataAndFileURLChangeTracker(classpathURLConverter));
    }

    OrionComponentTemplateSourceImpl(TemplateParser parser, ComponentTemplateLocator locator, DataAndFileURLChangeTracker tracker)
    {
        this.parser = parser;
