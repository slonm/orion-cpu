...
import orion.tapestry.internal.utils.DataAndFileURLChangeTracker;

/**
 * Service implementation that manages a cache of parsed component templates.
 */
public final class OrionComponentTemplateSourceImpl extends InvalidationEventHubImpl implements ComponentTemplateSource, UpdateListener
{
    ...
    private final DataAndFileURLChangeTracker tracker;
    ...
    public OrionComponentTemplateSourceImpl(TemplateParser parser, PageTemplateLocator locator,
                                       ClasspathURLConverter classpathURLConverter)
    {
        this(parser, locator, new DataAndFileURLChangeTracker(classpathURLConverter));
    }

    OrionComponentTemplateSourceImpl(TemplateParser parser, PageTemplateLocator locator, DataAndFileURLChangeTracker tracker)
    {
        this.parser = parser;
