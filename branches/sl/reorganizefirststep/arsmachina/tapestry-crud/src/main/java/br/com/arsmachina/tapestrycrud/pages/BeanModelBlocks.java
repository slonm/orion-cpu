 ...
 * </p>
 * Багобиксы оригинального модуля. Добавлен validator (Mihail Slobodyanuk)
 * @author Thiago H. de Paula Figueiredo
 */
public class BeanModelBlocks {

	@Inject
	private EncoderSource labelEncoderSource;

	@Inject
	private CrudSelectModelFactory selectModelFactory;
	...
	public String getEntity() {
		...
		Encoder labelEncoder = labelEncoderSource.get(propertyValue.getClass());
	...
	public SelectModel getEntityModel() {
		...
		Class beanType = beanEditContext.getBeanClass();
		String propertyName = editContext.getPropertyId();
		return selectModelFactory.create(propertyName, beanType);
