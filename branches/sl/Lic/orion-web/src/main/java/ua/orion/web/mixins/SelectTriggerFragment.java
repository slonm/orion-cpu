...
/**
 * A mixin that can be applied to a {@link org.apache.tapestry5.corelib.components.Select}
 ...
 * the
 * FormFragment.
 * Based on org.apache.tapestry5.corelib.mixins.TriggerFragment
 */
@Import(library={"SelectTriggerFragment.js"})
public class SelectTriggerFragment
{
    @InjectContainer
    ...
    void beginRender()
    {
        ...
        javascriptSupport.addInitializerCall("linkSelectTriggerToFormFragment", spec);
    }
}
