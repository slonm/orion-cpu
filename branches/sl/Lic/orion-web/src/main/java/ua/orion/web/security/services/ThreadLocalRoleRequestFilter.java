 ...
 * @author sl
 */
public class ThreadLocalRoleRequestFilter implements HttpServletRequestFilter, PageRenderLinkTransformer, ComponentEventLinkTransformer {
    ...
    public Link transformPageRenderLink(Link defaultLink, PageRenderRequestParameters parameters) {
        return transformLink(defaultLink);
    }

    public Link transformLink(Link defaultLink) {
    ...
    @Override
    public Link transformComponentEventLink(Link link, ComponentEventRequestParameters cerp) {
        return transformLink(link);
    }

    @Override
    public ComponentEventRequestParameters decodeComponentEventRequest(Request rqst) {
        return null;
    }
}
