...
public class CrudEdit {
    ...
    //    /**
    //     * Константа, название стартовой страницы
    //     */
    //    @Inject
    //    @Symbol(SymbolConstants.START_PAGE_NAME)
    //    private String startPageName;
    /**
     * Страница "Создать запись"
     * на случай, если экземпляр сущности не найден
     */
    @InjectPage
    ...
    public BeanModel getBeanModel() {
        ...
        BeanModel beanModel = dataSource.getBeanModelForEdit(entityClass, messages);
        return beanModel;
    }
    ...
    public Object onActivate(EventContext context) {
        ...
        if (objEntity != null) {
            ...
            // CrudCreate createPage=new CrudCreate();
            createPage.setEntityClass(entityClass);
            createPage.setFeedbackMessage(messages.get("crud-entity-not-found-creating"));
            return createPage;
        }
