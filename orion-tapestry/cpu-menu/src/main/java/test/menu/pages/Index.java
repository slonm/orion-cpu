...
public class Index {
    ...
    @Inject
    private ComponentResources LinkSource;

    public ArrayList<MenuData> getCpuMenu() {
        Object[] context = null;
        ArrayList<MenuData> menu = cpuMenu.getMenu("Start>abo", LinkSource, context);
        return menu;
    }

    public MenuData getContextMenu(int someid) {
        Object[] context = null;
        MenuData menu = cpuMenu.getOneMenu("Start>abo", LinkSource, context);
        return menu;
    }
}
