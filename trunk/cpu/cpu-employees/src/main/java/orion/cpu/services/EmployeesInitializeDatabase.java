 ...
 * @author sl
 */
public class EmployeesInitializeDatabase extends OperationTypes implements Runnable {

    private static final Logger LOG = LoggerFactory.getLogger(EmployeesInitializeDatabase.class);
    private final InitializeDatabaseSupport iDBSpt;

    public EmployeesInitializeDatabase(InitializeDatabaseSupport initializeDatabaseSupport) {
...
/*        SubSystem subSystem=iDBSpt.saveOrUpdateSubSystem("Units");
        ...
        Map<String, Permission> OUPermissions = iDBSpt.getPermissionsMap(Employee.class, READ_OP, REMOVE_OP, STORE_OP, UPDATE_OP, MENU_OP);
