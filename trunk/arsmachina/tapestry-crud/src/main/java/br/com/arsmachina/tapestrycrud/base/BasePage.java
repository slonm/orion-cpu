...
public abstract class BasePage<T, K extends Serializable> implements CrudPage<T, K> {
    ...
    public BasePage() {
        try {
            ...
            LOG.info("Default initialization failed: "+x.getMessage());
        }

    }

    /**
     * initialize entityClass, primaryKeyClass, controller,primaryKeyEncoder  fields
     */
    @SuppressWarnings("unchecked")
