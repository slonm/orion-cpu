...
/**
 * Атрибут типа "длинное целое"
 * @author dobro
 */
public class GridPropertyModelLong extends GridPropertyModelAdapter {

    public GridPropertyModelLong(
        ...
        GridFilterDataType datatype = new GridFilterDataTypeLong();
