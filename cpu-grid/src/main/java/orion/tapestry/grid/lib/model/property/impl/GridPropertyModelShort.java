 ...
 * @author dobro
 */
public class GridPropertyModelShort extends GridPropertyModelAdapter{
    public GridPropertyModelShort(
        ...
        GridFilterDataType datatype = new GridFilterDataTypeShort();
